  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2">
        ...
        <div className="flex justify-center items-center bg-primary-150">
          <div>
            ...
            <div className="flex gap-5 text-primary-150 mb-8">
              <Link href="/auth/signin">
                <button className="py-3 px-20 bg-primary-200 font-semibold rounded-2xl border border-secondary-200 hover:scale-105">Sign In</button>
              </Link>
              <Link href="/auth/signup">
                <button className="py-3 px-20 bg-primary-200 font-semibold rounded-2xl border border-secondary-200 hover:scale-105">Sign Up</button>
              </Link>
            </div>
          </div>
        </div>
