          ...
          <div className="flex justify-center items-center gap-32">
            <div className="ml-14">
              ...
              <form action="#" className="flex flex-col gap-4">
                <input type="text" placeholder="Fullname" className="w-full p-2 border text-sm border-secondary-100 rounded-xl" />
                ...
                <button className="py-2 font-semibold bg-primary-200 text-primary-150 rounded-xl border border-secondary-100 hover:scale-105 active:bg-warm-50">Sign Up</button>
              </form>
